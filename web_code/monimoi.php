...
<div class="navbar">
  ...
  <a href="edip.php">Καθηγητές Ε.ΔΙ.Π</a>
            ...
            <p>  <button style="font-size:25px;" class="Btn_white_normal">
                       <a href="konstantinou.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
          <b>Κωνσταντίνου Ελισάβετ</b>     </a>
               </button></p>

          <p>  <button style="font-size:25px;" class="Btn_blue_normal">
             <a href="kalligeros.php" style="color:rgb(24,110,175); text-decoration: none;">
<b>Καλλίγερος Εμμανουήλ</b>
             </a></button>
    </p>

    <button style="font-size:25px;" class="Btn_white_normal">
             <a href="kaporis.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
    <b>Καπόρης Αλέξιος</b>     </a>
     </button>

  <p>   <button style="font-size:25px;" class="Btn_white_normal">
              <a href="karuda.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
     <b>Καρύδα Μαρία</b>     </a>
      </button></p>
