...
<div class="navbar">
  ...
  <a href="edip.php">Καθηγητές Ε.ΔΙ.Π</a>
            ...
            <p>  <button style="font-size:25px;" class="Btn_white_normal">
                       <a href="leoutsakos.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
          <b>Λεουτσάκος Θεόδωρος</b>     </a>
               </button></p>

               <button style="font-size:25px;" class="Btn_white_normal">
                        <a href="douma.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
               <b>Δούμα Αναστασία</b>     </a>
                </button>
