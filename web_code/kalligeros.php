...
<head>
  <title>KAΛΛΙΓΕΡΟΣ ΕΜΜΑΝΟΥΗΛ</title>
  <meta charset="UTF-8">
  ...
  <div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-padding-64">
      ...
      <div class="w3-twothird w3-container">
        ...
        <div id="header">
          <h1>KAΛΛΙΓΕΡΟΣ ΕΜΜΑΝΟΥΗΛ: Μόνιμος Επίκουρος Καθηγητής</h1>
          <hr style="height:2px;border-width:0;color:gray;background-color:gray">

        <!--<p id="name"><b><h2>ΑΛΕΞΙΟΣ ΚΑΠΟΡΗΣ: Μόνιμος Επίκουρος Καθηγητής</b></p></h2>-->
        <h3>Προσωπικές πληροφορίες:</h3>
            <b>Email: </b>kalligeros@gmail.com<p>
            <b>Τηλέφωνο: </b>22730-82327<p>
            <b>Γραφείο: </b>Α3 (Παλαμά 2)<p>
            </div>
            <hr></hr>
             ...
             <div class="right">
                    ...
                    <p align="justify">
                    <ul>
                        <li>Δίπλωμα Μηχανικού Ηλεκτρονικών Υπολογιστών και Πληροφορικής, Πανεπιστήμιο Πατρών</li>
                        <li>Μεταπτυχιακό Δίπλωμα Ειδίκευσης στην Επιστήμη και Τεχνολογία των Υπολογιστών, Τμήμα Μηχανικών Ηλεκτρονικών Υπολογιστών και Πληροφορικής, Πανεπιστήμιο Πατρών</li>
                        <li>Διδακτορικό Δίπλωμα σε Τεχνικές Ενσωματωμένου Ελέγχου Ψηφιακών Κυκλωμάτων, Τμήμα Μηχανικών Ηλεκτρονικών Υπολογιστών και Πληροφορικής, Πανεπιστήμιο Πατρών</li>
                      </ul>
                    </p>
                    <hr></hr>
                    <h3>Ερευνητικά Ενδιαφέροντα:</h3>
                    <p align="justify">
                  Σχεδίαση και έλεγχος ψηφιακών κυκλωμάτων και συστημάτων, Σχεδίαση και έλεγχος ψηφιακών κυκλωμάτων και συστημάτων, Δίκτυα διασύνδεσης ενσωματωμένα σε ολοκληρωμένα (NoCs), Σχεδίαση για αυξημένη ελεγξιμότητα, Συμπίεση δεδομένων ελέγχου ψηφιακών κυκλωμάτων</p>
                  <hr></hr>
                    <h3>Διδασκαλία:</h3>
                    <p align="justify">
                    <ul>
                    <li>Λογική Σχεδίαση</li>
                    <li>Σχεδίαση Ψηφιακών Συστημάτων</li>
                    <li>Εισαγωγή σε VLSI</li>
                    <li>Δορυφορικές Επικοινωνίες
                    </li>
                    <li>Ενσωματωμένα Συστήματα και Διαδίκτυο των Πραγμάτων (μεταπτυχιακό)</li>
