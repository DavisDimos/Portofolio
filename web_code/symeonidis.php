...
<head>
  <title>ΠΑΝΑΓΙΩΤΗΣ ΣΥΜΕΩΝΙΔΗΣ</title>
  <meta charset="UTF-8">
  ...
  <div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-padding-64">
      ...
      <div class="w3-twothird w3-container">
        ...
        <body>
          <div id="header">
            <h1 >ΠΑΝΑΓΙΩΤΗΣ ΣΥΜΕΩΝΙΔΗΣ: Αναπηρωτής Καθηγητής</h1>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">

          <h3>Προσωπικές πληροφορίες:</h3>
              <b>Email: </b>psymeonidis@aegean.gr<p>
              <b>Τηλέφωνο: </b>22730-43678<p>
              <b>Γραφείο:</b>Κτίριο Λυμπέρη,Γραφείο Β8<p>
...
<hr></hr>
                      ...
                      <p align="justify">
                      <ul>
                          <li>Πτυχίο Εφαρμοσμένης Πληροφορικής, Πανεπιστήμιο Μακεδονίας.</li>
                          <li>Μεταπτυχιακό Δίπλωμα στα Πληροφοριακά Συστήματα, ΔΠΜΣ Πανεπιστημίου Μακεδονίας</li>
                          <li>Διδακτορικό Δίπλωμα στην Ανάκτηση Πληροφοριών και Εξόρυξη Δεδομένων για Εξατομίκευση Υπηρεσιών Παγκόσμιου Ιστού, Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης.</li>
                      </ul>
                      </p>
                      <hr></hr>
                      ...
                      <p align="justify">
                      <ul>
                       <li>  Βάσεις Δεδομένων Ι</li>
                        <li>  Βάσεις Δεδομένων ΙΙ</li>
                        <li>Ευφυή Συστήματα Συστάσεων </li>
                        <li> Ανάκτηση Πληροφορίας</li>
                        <li>Αντ. Προγραμματισμός ΙΙ</li>
                        <li>Σημασιολογικός Ιστός </li>
                        <li>Μεγάλα Δεδομένων και Εξόρυξη Δεδομένων</li>
