...
<head>
  <title>EΛΙΣΑΒΕΤ ΚΩΝΣΤΑΝΤΙΝΟΥ</title>
  <meta charset="UTF-8">
  ...
  <div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-padding-64">
      ...
      <div class="w3-twothird w3-container">
        ...
        <body>
          <div id="header">
            <h1 >EΛΙΣΣΑΒΕΤ ΚΩΝΣΤΑΝΤΙΝΟΥ: Αναπληρώτρια Καθηγήτρια</h1>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">

          <!--<p id="name"><b><h2>ΑΛΕΞΙΟΣ ΚΑΠΟΡΗΣ: Μόνιμος Επίκουρος Καθηγητής</b></p></h2>-->
          <h3>Προσωπικές πληροφορίες:</h3>
              <b>Email: </b>elisaveto@aegean.gr<p>
              <b>Τηλέφωνο: </b>22730-82268<p>
              <b>Γραφείο:</b>Β2<p>
            ...
            <hr></hr>
                      ...
                      <p align="justify">
                      <ul>
                          <li>Πτυχίο Πληροφορικής, Πανεπιστήμιο Ιωαννίνων</li>
                          <li>Μεταπτυχιακό Δίπλωμα Ειδίκευσης, Τμήμα Μηχανικών Η/Υ και Πληροφορικής, Πανεπιστήμιο Πατρών</li>
                          <li>Διδακτορικό Δίπλωμα, Τμήμα Μηχανικών Η/Υ και Πληροφορικής, Πανεπιστήμιο Πατρών</li>
                        </ul>
                      </p>
                      <br>
                      <h3>Ερευνητικά Ενδιαφέροντα:</h3>
                      <p align="justify">
                      Ελλειπτικές καμπύλες, γεννήτριες τυχαίων αριθμών, κρυπτογραφικά συστήματα δημόσιου κλειδιού, αλγεβρική θεωρία αριθμών, τεχνολογίες υλοποίησης αλγορίθμων, κβαντική κρυπτογραφία
                        <br>
          ...
          <hr></hr>
                      ...
                      <p align="justify">
                      <ul>
                      <li>Εισαγωγή στην Επιστήμη των Υπολογιστών και Επικοινωνιών</li>
                      <li>Στοχαστική Ανάλυση</li>
                      <li>Κρυπτογραφία</li>
                      <li>Μαθηματική Μοντελοποίηση</li>
                      <li>Κρυπτογραφία (ΠΜΣ)</li>
                      <li>Προηγμένα Μαθηματικά</li>
