...
<div class="navbar">
  ...
  <a href="edip.php">Καθηγητές Ε.ΔΙ.Π</a>
            ...
            <p>  <button style="font-size:25px;" class="Btn_white_normal">
                       <a href="maliatsos.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
          <b>Μαλιάτσος Κωνσταντίνος</b>     </a>
               </button></p>

               <button style="font-size:25px;" class="Btn_white_normal">
                        <a href="symeonidis.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
               <b>Συμεωνίδης Παναγιώτης</b>     </a>
                </button>
          <p>  <button style="font-size:25px;" class="Btn_blue_normal">
             <a href="kwstoulas.php" style="color:rgb(24,110,175); text-decoration: none;">
<b>Κωστούλας Θεόδωρος</b>
             </a></button>
    </p>


  <p>   <button style="font-size:25px;" class="Btn_white_normal">
              <a href="vlachou.php" style="color:rgb(24, 110, 175);  text-decoration: none; ">
     <b>Βλάχου Ακριβή</b>     </a>
      </button></p>
      <div class="w3-row">
