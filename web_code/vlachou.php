  ...
  <div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-padding-64">
      ...
      <div class="w3-twothird w3-container">
        ...
        <body>
          <div id="header">
            <h1 >ΑΚΡΙΒΗ ΒΛΑΧΟΥ: Αναπληρώτρια Καθηγήτρια</h1>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">

          <h3>Προσωπικές πληροφορίες:</h3>
              <b>Email: </b>avlaxou@aegean.gr<p>
              <b>Τηλέφωνο: </b>22730-13456<p>
              <b>Γραφείο:</b>Κτίριο Λυμπέρη,Γραφείο Β4<p>
               ...
               <div class="right">
                    <hr></hr>
                      ...
                      <ul>
                          <li>Διδακτορικό Δίπλωμα στην “Αποδοτική επεξεργασία επερωτήσεων σε ευρέως κατανεμημένα δεδομένα”, Τμήμα Πληροφορικής, Οικονομικό Πανεπιστήμιο Αθηνών.</li>
                          <li>Μεταπτυχιακές Σπουδές στα Προηγμένα Πληροφοριακά Συστήματα από το Τμήμα Πληροφορικής & Τηλεπικοινωνιών του Εθνικού και Καποδιστριακού Πανεπιστημίου Αθηνών.</li>
                          <li>Πτυχίο Πληροφορικής & Τηλεπικοινωνιών από το Εθνικό και Καποδιστριακό Πανεπιστήμιο Αθηνών.</li>
                      </p>
                      </ul>
                      <hr></hr>
                      <h3>Ερευνητικά Ενδιαφέροντα:</h3>
                      <p align="justify">
                        <p align="justify">Βάσεις χωρικών δεδομένων</p>

                        <p align="justify">Επεξεργασία χωρικών δεδομένων με κειμενική πληροφορία</p>

                        <p align="justify">Κατανεμημένη επεξεργασία δεδομένων</p>
          </ul>
          <hr></hr>
                      ...
                      <ul>
                        ...
                        <li>Εφαρμοσμένα Θέματα Δομών και Βάσεων Δεδομένων</li>
                        <li>Δίκτυα Υπολογιστών</li>
                        <li>Ρομποτικός Έλεγχος</li>
