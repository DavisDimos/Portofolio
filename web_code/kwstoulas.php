...
<head>
  <title>ΚΩΣΤΟΥΛΑΣ ΘΕΟΔΩΡΟΣ</title>
  <meta charset="UTF-8">
  ...
  <div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-padding-64">
      ...
      <div class="w3-twothird w3-container">
        ...
        <body>
          <div id="header">
            <h1 >ΚΩΣΤΟΥΛΑΣ ΘΕΟΔΩΡΟΣ: Αναπληρωτής Καθηγητής</h1>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray">

          <h3>Προσωπικές πληροφορίες:</h3>
              <b>Email: </b>thk@aegean.gr<p>
              <b>Τηλέφωνο: </b>22730-82224<p>
              <b>Γραφείο:</b>Παλαμά 2, Κτίριο Λιμπέρη - Β8<p>
               ...
               <div class="right">
                    <hr></hr>
                      ...
                      <ul>
                          <li>Δίπλωμα, Τμήμα Ηλεκτρολόγων Μηχανικών και Τεχνολογίας Υπολογιστών, Πανεπιστήμιο Πατρών (2005).
</li>
                          <li>Διδακτορικό, Τμήμα Ηλεκτρολόγων Μηχανικών και Τεχνολογίας Υπολογιστών, Πανεπιστήμιο Πατρών (2012).
</li>
                      </p>
                      </ul>
                      <hr></hr>
...
<li>Πολυτροπική Αλληλεπίδραση
</li>
<li>Επεξεργασία Πολυτροπικών Σημάτων
</li>
<li>Συναισθηματική Υπολογιστική
</li>
          ...
          <hr></hr>
                      ...
                      <p>
                      <ul>
                      <li>  <p align="justify">Μεγάλα Δεδομένα και Εξόρυξη Δεδομένων (Μεταπτυχιακό)
  </p></li>
                      <li>  <p align="justify">Σημασιολογικός Ιστός (Μεταπτυχιακό)
  </p></li>
                      <li>  <p align="justify">Ευφυή Συστήματα (Μεταπτυχιακό)
  </p></li>
                      <li>  <p align="justify">Αρχιτεκτονική Υπολογιστών (3ο Εξάμηνο)
  </p></li>
  <li>  <p align="justify">Τεχνητή Νοημοσύνη (6ο Εξάμηνο)
  </p></li>
  <li>  <p align="justify">Αποθήκες Δεδομένων και Εξόρυξη Γνώσης από Δεδομένα (8ο Εξάμηνο)
  </p></li>
  <li>  <p align="justify">Μηχανική Γνώσης και Συστήματα Γνώσης (9ο Εξάμηνο)
  </p></li>
